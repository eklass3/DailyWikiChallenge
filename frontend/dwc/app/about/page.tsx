    ...
    return (
        <main className="container">
            <div style={{width: '90%'}}>
                ...
                <p style={{maxWidth: 1000, lineHeight: 1.5}}>For all game modes you will probably notice the occasional odd wording in the questions, and relatively slow question loading time. This is typical GPT LLM growing pains. I’m hoping it will improve as time goes on, and I improve my prompts! My best tip for new players – think from the perspective of browsing Wikipedia. All the answers are actual Wikipedia article titles, so they may not be what you expect!</p>
                <p style={{maxWidth: 1000, lineHeight: 1.5}}>Daily Wiki Challenge was designed and engineered by <a href={"https://www.linkedin.com/in/eric-klassen-551616205/"} target="_blank">Eric Klassen</a> using Python Flask, OpenAI GPT4, and Next.js. Feel free to send me a message if you have any suggestions: eaklassen8 [at] gmail.com.</p>
